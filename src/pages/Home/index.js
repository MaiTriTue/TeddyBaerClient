    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('wrapper-billboard')}>
                <div className={cx('wrapper-billboard_slide')}>{/* <BillBeard /> */}</div>
                <div className={cx('wrapper-billboard_banner')}>
                    <div className={cx('wrapper-billboard_banner-20')}>{/* <BillBeardSale /> */}</div>
                    <div className={cx('wrapper-billboard_banner-15')}>{/* <BillBeardSale /> */}</div>
                </div>
            </div>
